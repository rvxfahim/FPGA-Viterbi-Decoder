...
The SystemVerilog module `decoder.sv` contains the stage-by-stage metric updates, branch metric calculation, and traceback/output logic that drives the decoded bits.
