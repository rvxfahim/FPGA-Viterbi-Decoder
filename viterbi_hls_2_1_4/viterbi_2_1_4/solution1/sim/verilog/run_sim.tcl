...
# ==============================================================
set ::env(PATH) "$::env(PATH);K:/Xilinx/Vivado/2019.1/win64/tools/fpo_v7_0"

set ::env(PATH) "$::env(PATH);K:/Xilinx/Vivado/2019.1/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);K:/Xilinx/Vivado/2019.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);K:/Xilinx/Vivado/2019.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);K:/Xilinx/Vivado/2019.1/win64/tools/dds_v6_0"
...
if {[file isfile decoder.autotvin.dat]} {
	file delete -force decoder.autotvin.dat
}

if {[file isfile decoder.autotvout.dat]} {
	file delete -force decoder.autotvout.dat
}
